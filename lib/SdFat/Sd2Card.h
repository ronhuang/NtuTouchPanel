...
// If Arduino Mega
#define SPI_SS_PIN   53  // Slave Select pin for card
#define SPI_MOSI_PIN 51  // spi master output, slave input pin
#define SPI_MISO_PIN 50  // spi master input, slave output pin
#define SPI_SCK_PIN  52  // spi serial clock pin
#else //__AVR_ATmega1280__
//  168/318 Arduinos
#define SPI_SS_PIN   10  // Slave Select pin for card
#define SPI_MOSI_PIN 11  // spi master output, slave input pin
#define SPI_MISO_PIN 12  // spi master input, slave output pin
#define SPI_SCK_PIN  13  // spi serial clock pin
